...
import type { BuildSinkCarbonXdrData, BuildSinkCarbonXdrErrors, BuildSinkCarbonXdrResponses, CreateRecipientData, CreateRecipientErrors, CreateRecipientResponses, DeleteRecipientData, DeleteRecipientErrors, DeleteRecipientResponses, GetCarbonQuoteData, GetCarbonQuoteErrors, GetCarbonQuoteResponses, GetCarbonStatsData, GetCarbonStatsErrors, GetCarbonStatsResponses, GetFlightEstimateData, GetFlightEstimateErrors, GetFlightEstimateResponses, GetMintedBlockListData, GetMintedBlockListErrors, GetMintedBlockListResponses, GetRecipientData, GetRecipientErrors, GetRecipientResponses, GetRecipientStatsData, GetRecipientStatsErrors, GetRecipientStatsResponses, GetRetirementItemData, GetRetirementItemErrors, GetRetirementItemResponses, GetRetirementListData, GetRetirementListErrors, GetRetirementListResponses, GetRetirementsForBeneficiaryData, GetRetirementsForBeneficiaryErrors, GetRetirementsForBeneficiaryResponses, GetSep10ChallengeData, GetSep10ChallengeErrors, GetSep10ChallengeResponses, GetSinkTxItemData, GetSinkTxItemErrors, GetSinkTxItemResponses, GetSinkTxListData, GetSinkTxListErrors, GetSinkTxListResponses, GetSinkTxsForRecipientData, GetSinkTxsForRecipientErrors, GetSinkTxsForRecipientResponses, GetUsdQuoteData, GetUsdQuoteErrors, GetUsdQuoteResponses, RequestCertificateData, RequestCertificateErrors, RequestCertificateResponses, UpdateRecipientData, UpdateRecipientErrors, UpdateRecipientResponses, ValidateSep10ChallengeData, ValidateSep10ChallengeErrors, ValidateSep10ChallengeResponses } from './types.gen';
 ...
 */
export const getSep10Challenge = <ThrowOnError extends boolean = false>(options: Options<GetSep10ChallengeData, ThrowOnError>) => (options.client ?? client).get<GetSep10ChallengeResponses, GetSep10ChallengeErrors, ThrowOnError>({ url: '/auth/sep-10', ...options });
 ...
 */
export const validateSep10Challenge = <ThrowOnError extends boolean = false>(options?: Options<ValidateSep10ChallengeData, ThrowOnError>) => (options?.client ?? client).post<ValidateSep10ChallengeResponses, ValidateSep10ChallengeErrors, ThrowOnError>({
    url: '/auth/sep-10',
    ...options,
    headers: {
 ...
 */
export const getCarbonQuote = <ThrowOnError extends boolean = false>(options?: Options<GetCarbonQuoteData, ThrowOnError>) => (options?.client ?? client).get<GetCarbonQuoteResponses, GetCarbonQuoteErrors, ThrowOnError>({ url: '/carbon/carbon-quote', ...options });
 ...
 */
export const getUsdQuote = <ThrowOnError extends boolean = false>(options?: Options<GetUsdQuoteData, ThrowOnError>) => (options?.client ?? client).get<GetUsdQuoteResponses, GetUsdQuoteErrors, ThrowOnError>({ url: '/carbon/usd-quote', ...options });
 ...
 */
export const buildSinkCarbonXdr = <ThrowOnError extends boolean = false>(options: Options<BuildSinkCarbonXdrData, ThrowOnError>) => (options.client ?? client).post<BuildSinkCarbonXdrResponses, BuildSinkCarbonXdrErrors, ThrowOnError>({ url: '/carbon/sink-carbon/xdr', ...options });
 ...
 * in circulation.
 */
export const getCarbonStats = <ThrowOnError extends boolean = false>(options?: Options<GetCarbonStatsData, ThrowOnError>) => (options?.client ?? client).get<GetCarbonStatsResponses, GetCarbonStatsErrors, ThrowOnError>({ url: '/carbon/stats', ...options });
 ...
 */
export const getSinkTxsForRecipient = <ThrowOnError extends boolean = false>(options: Options<GetSinkTxsForRecipientData, ThrowOnError>) => (options.client ?? client).get<GetSinkTxsForRecipientResponses, GetSinkTxsForRecipientErrors, ThrowOnError>({ url: '/recipients/{recipient_address}/sink-txs', ...options });
 ...
 */
export const getRetirementsForBeneficiary = <ThrowOnError extends boolean = false>(options: Options<GetRetirementsForBeneficiaryData, ThrowOnError>) => (options.client ?? client).get<GetRetirementsForBeneficiaryResponses, GetRetirementsForBeneficiaryErrors, ThrowOnError>({ url: '/recipients/{beneficiary_address}/retirements', ...options });
 ...
 */
export const getRecipientStats = <ThrowOnError extends boolean = false>(options: Options<GetRecipientStatsData, ThrowOnError>) => (options.client ?? client).get<GetRecipientStatsResponses, GetRecipientStatsErrors, ThrowOnError>({ url: '/recipients/{recipient_address}/stats', ...options });
 ...
 */
export const deleteRecipient = <ThrowOnError extends boolean = false>(options: Options<DeleteRecipientData, ThrowOnError>) => (options.client ?? client).delete<DeleteRecipientResponses, DeleteRecipientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getRecipient = <ThrowOnError extends boolean = false>(options: Options<GetRecipientData, ThrowOnError>) => (options.client ?? client).get<GetRecipientResponses, GetRecipientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/recipients/{recipient_address}',
    ...options
});
 ...
 */
export const requestCertificate = <ThrowOnError extends boolean = false>(options: Options<RequestCertificateData, ThrowOnError>) => (options.client ?? client).post<RequestCertificateResponses, RequestCertificateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getFlightEstimate = <ThrowOnError extends boolean = false>(options: Options<GetFlightEstimateData, ThrowOnError>) => (options.client ?? client).get<GetFlightEstimateResponses, GetFlightEstimateErrors, ThrowOnError>({ url: '/estimate/flight', ...options });
 ...
 */
export const getMintedBlockList = <ThrowOnError extends boolean = false>(options?: Options<GetMintedBlockListData, ThrowOnError>) => (options?.client ?? client).get<GetMintedBlockListResponses, GetMintedBlockListErrors, ThrowOnError>({ url: '/minted-blocks/', ...options });
 ...
 */
export const getRetirementList = <ThrowOnError extends boolean = false>(options?: Options<GetRetirementListData, ThrowOnError>) => (options?.client ?? client).get<GetRetirementListResponses, GetRetirementListErrors, ThrowOnError>({ url: '/retirements/', ...options });
 ...
 * error is returned.
 */
export const getRetirementItem = <ThrowOnError extends boolean = false>(options: Options<GetRetirementItemData, ThrowOnError>) => (options.client ?? client).get<GetRetirementItemResponses, GetRetirementItemErrors, ThrowOnError>({ url: '/retirements/{certificate_id}', ...options });
 ...
 */
export const getSinkTxList = <ThrowOnError extends boolean = false>(options?: Options<GetSinkTxListData, ThrowOnError>) => (options?.client ?? client).get<GetSinkTxListResponses, GetSinkTxListErrors, ThrowOnError>({ url: '/sink-txs/', ...options });
 ...
 */
export const getSinkTxItem = <ThrowOnError extends boolean = false>(options: Options<GetSinkTxItemData, ThrowOnError>) => (options.client ?? client).get<GetSinkTxItemResponses, GetSinkTxItemErrors, ThrowOnError>({ url: '/sink-txs/{tx_hash}', ...options });
